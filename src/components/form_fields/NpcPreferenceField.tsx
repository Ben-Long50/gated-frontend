              ...
              >
                ...
                >
                  ...
                  <p className="text-tertiary border-l-2 border-gray-400 border-opacity-50 pl-4">
                    Set your visibility preferences for this NPC. These options
                    will determine how much of this NPC's information is
                    viewable by players when interacting with them. If a box is
                    checked, that means players can see that information.
                  </p>
                  <Divider />
