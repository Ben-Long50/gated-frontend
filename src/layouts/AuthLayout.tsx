...
const AuthLayout = () => {
  ...
  return (
    <div
      ...
      style={{
        '--accent-primary': accentPrimary as React.CSSProperties,
    ...
    >
      ...
      <motion.div
        className="z-20 flex h-full w-full max-w-[500px] flex-col items-center justify-center gap-6 overflow-visible border-opacity-50 bg-fixed sm:col-span-1"
